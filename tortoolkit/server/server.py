    ...
    <header>
      <div class="brand">
        <img
          ...
          alt="logo"
        />
        <a href="https://t.me/EDM115bots"> 
          <h2 class="name">MultiPurpose Bot</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://github.com/EDM115/leechy-bot"><i class="fab fa-github"></i></a>
        <a href="https://t.me/multi_purpose_robot"><i class="fab fa-telegram"></i></a>
        <a href="https://t.me/EDM115bots"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <section>
...
<body>
   <!--© Designed and coded by @bipuldey19-Telegram (modded for TTK by AmirrulAndalib)-->
    <header>
      ...
      <div class="social">
        <a href="https://www.github.com/EDM115/leechy-bot"><i class="fab fa-github"></i></a>
        <a href="https://t.me/multi_purpose_robot"><i class="fab fa-telegram"></i></a>
        <a href="https://t.me/EDM115bots"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <section>
      <form action="{form_url}">
        ...
        <button type="submit" class="btn btn-primary">Submit</button>
          ...
          <span>*Don't enter a wrong code, or your download will never start 🙃</>
    </section>
</body>
</html>
"""
...
async def list_torrent_contents(request):
    # not using templates cuz wanted to keep things in one file, might change in future #todo
