...
class DLGen(BaseTask):
    ...
    async def generate_directs(self, url):
        ...
        or '1fichier.com' in url or 'googleusercontent.com' in url:
    ...
    async def mediafile_dl(self):
        try:
            ...
            self._is_errored = True
            self._error_reason = "**ERROR :** Can't download, double check your mediafire link 🧐!"
            return False
    ...
    async def yadisk_dl(self):
        try:
            ...
            self._is_errored = True
            self._error_reason = "**ERROR :** Can't download, double check your yadisk link 🧐!"
            return False
        ...
        try:
            ...
            self._is_errored = True
            self._error_reason = "**ERROR :** Can't download, the yadisk file not found or download limit reached 😪!" 
            return False
    ...
    async def zippyshare_dl(self):
        try:
            ...
            self._is_errored = True
            self._error_reason = "**ERROR :** Can't download, double check your zippyshare link 🧐!"
            return False
    ...
    async def racaty_dl(self):
        try:
            ...
            self._is_errored = True
            self._error_reason = "**ERROR :** Can't download, double check your racaty link 🧐!"
            return False
    ...
    async def pixeldrain_dl(self):
        ...
        if restext["success"]:
            ...
            self._is_errored = True
            self._error_reason = "**ERROR :** Can't download, {}".format(restext["value"])
            return False
    ...
    async def uptobox_dl(self):
        try:
            ...
            self._is_errored = True
            self._error_reason = "**ERROR :** Can't find download link 😐"
            return False
