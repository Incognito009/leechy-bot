...
class Aria2Downloader(BaseTask):
    ...
    async def execute(self):
        ...
        if self._dl_link.lower().startswith("magnet:"):
            ...
            self._error_reason = "Can't download this torrent file 😐"
            return False
        ...
        try:
            ...
            if not complete:
                if not file.error_message:             
                    ...
                    torlog.error(f"The aria download failed due to this reason : {file.error_message}")
                    return False
            ...
            self._is_errored = True
            if " not found" in str(e) or "'file'" in str(e):
                self._error_reason = "The Download was canceled 🙅‍♂️"
                return False
            else:
                torlog.exception(e)
